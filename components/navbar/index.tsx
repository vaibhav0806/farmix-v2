...
export default function Navbar() {
  ...
  return (
    <div className="flex flex-row h-[5rem] items-center justify-between px-16 border-b-[1px] border-b-[#3fc9f3] bg-black">
      <div className="flex flex-row gap-2">
        {/* <Image src='/TrustifyLogo.png' width={20} height={20} alt="Trustify Logo" /> */}
        <div
          onClick={() => router.push("/")}
          className="text-2xl font-poppins hover:cursor-pointer text-white"
        >
          Farmix
        </div>
      </div>
        ...
        <Dropdown className="bg-black">
          <DropdownTrigger>
            <Button
              ...
              className="bg-[#3fc9f3] shadow-[0_0_5px_#B2F1A8] text-black rounded-md py-1 px-3 flex flex-row justify-center items-center"
            >
              {authenticated && (
                <div>
                  <img
